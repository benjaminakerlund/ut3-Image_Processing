...
TFdIrest = (COMPLETE HERE)
Irest = (COMPLETE HERE)

Irest = uint8(Irest);
figure,imshow(Irest),title('Image non bruitée restaurée par filtrage inverse');
...
%     Irestb = uint8(Irestb);
%     figure,imshow(Irestb),title('Image bruitée restaurée par filtrage inverse');
% end
